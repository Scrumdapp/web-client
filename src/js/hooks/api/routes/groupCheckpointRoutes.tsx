...
export function getGroupCheckpoints() {
  return createProcessor(
    "getGroupCheckpoints",
    (groupId: number, session?: number, user?: number) => {
      return makeApiRequest<GroupCheckpoint[]>(
        "GET",
        "/groups/{groupId}/checkpoints",
        {
...
export function updateGroupCheckpoint() {
  return createProcessor(
    "updateGroupCheckpoint",
    (groupId: number, checkpoint: UpdateGroupCheckpoint) => {
      return makeApiRequest<GroupCheckpoint>(
        "PATCH",
        "/groups/{groupId}/checkpoints",
        {
