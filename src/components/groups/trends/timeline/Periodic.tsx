...
import {
  ...
  getAttendanceLabelKeyTrends,
} from "../../../../js/utils/colorUtils";
import {
  parseScrumdappDate,
  toScrumdappDate,
} from "../../../../js/utils/scrumdappDate";
import {
  getWeekNumber,
  getWeekStart,
  parseWeekDay,
    ...
    <table>
      <thead>
        <tr>
          <th></th>
          <th>
            <TimelineWeekDisplays trends={data.trends[0]} />
          </th>
        </tr>
      </thead>
      <tbody>
      ...
      {trends.days.map((trend, i) => (
        ...
        >
          <div className="dropdown-content">
            <p>
              {t(parseWeekDay(parseScrumdappDate(trend.date).getUTCDay()))}{" "}
              {trend.date}
            </p>
              ...
              <tbody>
                {trend.presences.map((it, i) => (
                  <tr key={i}>
                    ...
                    <td
                      className={`text-nowrap ${getAttendanceColorScrummaster(it.presence)}`}
                    >
