...
export default function Header() {
    ...
    const links = [
        ...
        return (
    <div className="bg-(--bg-primary) border-(--color-primary)">
        <nav className="pt-4 pb-7 px-2 flex flex-col">
            <div className="mx-auto px-4 lg:px-12 rounded-2xl bg-bg shadow-xl border footer w-11/12">
                ...
                <div className="flex justify-between h-16 items-center">
                    ...
                    <div className="shrink-0 text-(--color-primary) text-2xl font-bold">
            ...
            {/*WORK IN PROGRESS, NEED TO LOOK AT THIS AT A LATER TIME, NOT AS IMPORTANT RIGHT NOW*/}
